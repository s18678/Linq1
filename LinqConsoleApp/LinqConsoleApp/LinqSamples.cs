    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad2()
        {
            ...
            var res = Emps.Where(x => (x.Job == "Frontend programmer" && x.Salary > 1000)).OrderByDescending(x => x.Ename).Select(x=> new
                        {
                            Nr = x.Empno,
                            Nazwisko = x.Ename,
                            Zawod = x.Job,
        ...
        public void Przyklad3()
        {
            ...
            var res = Emps.OrderByDescending(x => x.Salary).Select(x => new
            {
                Sal = x.Salary
            }).First();
        ...
        public void Przyklad4()
        {
            ...
            var res = Emps.Where(x => (x.Salary == Emps.Max(y => y.Salary))).Select(x => new
            {
                Nr = x.Empno,
                Nazwisko = x.Ename,
                Zawod = x.Job,
        ...
        public void Przyklad6()
        {
            ...
            var res2 =
                from emp in Emps
                join deptt in Depts on emp.Deptno equals deptt.Deptno
                select new
                {
                    Imie = emp.Ename,
                    Praca = emp.Job,
                    Departament = deptt.Dname
                };
        ...
        public void Przyklad12()
        {
            ...
            var res = Emps.SelectMany(x => Depts, (y, z) => { return new { emp = y, dept = z };}) ;
